var HEROES = [
    {
      ...
      "dificuldade": "Hard",
      "posicao": "Support",
      "arma": "RIFLE BIÓTICO|O rifle de Ana atira dardos que podem restaurar a vida de seus aliados ou causar dano continuado a seus inimigos. Ela é capaz de usar a mira telescópica de seu rifle para dar tiros incrivelmente precisos.|biotic_fifle",
      "habilidades": 
        [ 
    ...
    },
    {
      ...
      "dificuldade": "Hard",
      "posicao": "Damage",
      "arma": "CANHÃO DE MÃO|Doomfist dispara uma explosão de curto alcance de seu punho. A munição se regenera automaticamente depois de um curto período.|hand_cannon",
      "habilidades": 
        [
